...
/*
  ...
  - To get the maximum benifit of part4_implicits, without confusing the compiler.
 */
object Organizing extends App {
  ...
  /*
  2. Implicit scope - Places the compiler searches for part4_implicits.
    ...
    - companion object of all types involved in the method signature
      ...
      - for this method call, part4_implicits will be searched in
