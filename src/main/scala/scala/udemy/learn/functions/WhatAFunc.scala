...
object WhatAFunc extends App {
  ...
  // ALL functions are instances of classes DERIVED from functional types (Function1, Function2)
  ...
  // Curried function: Curried functions have the property, that they can be called with
